...
import { getPlaceholderMessage } from '@/app/utils/messages';
...
export default function ChatInput({ value, onChange, onSend, isThinking, language }: ChatInputProps) {
    ...
    <footer className="fixed bottom-0 left-0 right-0 z-10 p-4 border-t border-gray-700 bg-[#003366]">
      <div className="relative flex items-end w-full max-w-[1000px] mx-auto">
        <textarea
          ...
          placeholder={getPlaceholderMessage(language)}
          value={value}
